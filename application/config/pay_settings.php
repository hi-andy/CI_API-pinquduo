...
$config['wx_js_pay']=[
    ...
    'cert_path'=>realpath(APPPATH.'storage/jscert/apiclient_cert.pem'),
    'key_path'=>realpath(APPPATH.'storage/jscert/apiclient_key.pem'),
    'notify_url'=>''
];
...
$config['wx_app_pay']=[
    ...
    'cert_path'=>realpath(APPPATH.'storage/cacert/apiclient_cert.pem'),
    'key_path'=>realpath(APPPATH.'storage/cacert/apiclient_key.pem')
];